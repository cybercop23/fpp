...
LIBS_fpp_co_BBB48String_so += -L. -lfpp -ljsoncpp -lfpp_capeutils -lfpp-FalconV5Support -Wl,-rpath=$(SRCDIR):.
...
libfpp-co-BBB48String.$(SHLIB_EXT): $(OBJECTS_fpp_co_BBB48String_so) libfpp.$(SHLIB_EXT) libfpp_capeutils.$(SHLIB_EXT) libfpp-FalconV5Support.$(SHLIB_EXT)
