...
non-gpl/BBShiftPanel/BBShiftPanel_prefetch.out: non-gpl/BBShiftPanel/BBShiftPanel.asm
	/usr/bin/cpp -P -I/opt/fpp/src/pru -DAM62X -DPRU0_PREFETCH "/opt/fpp/src/non-gpl/BBShiftPanel/BBShiftPanel.asm" > "/tmp/BBShiftPanel_prefetch.asm"
	clpru -v3 -o -DAM62X -DPRU0_PREFETCH --endian=little --hardware_mac=on --obj_directory /tmp "/tmp/BBShiftPanel_prefetch.asm"
	clpru -v3 -DAM62X -DPRU0_PREFETCH -z /opt/fpp/src/pru/AM62x_PRU0.cmd -o "non-gpl/BBShiftPanel/BBShiftPanel_prefetch.out" "/tmp/BBShiftPanel_prefetch.obj" -i/usr/share/ti/cgt-pru/lib -i/usr/share/ti/cgt-pru/include --library=libc.a
	@rm "/tmp/BBShiftPanel_prefetch.asm" "/tmp/BBShiftPanel_prefetch.obj"

non-gpl/BBShiftPanel/BBShiftPanel_prefetch_16.out: non-gpl/BBShiftPanel/BBShiftPanel.asm
	/usr/bin/cpp -P -I/opt/fpp/src/pru -DAM62X -DOUTPUTS16 -DPRU0_PREFETCH "/opt/fpp/src/non-gpl/BBShiftPanel/BBShiftPanel.asm" > "/tmp/BBShiftPanel_prefetch_16.asm"
	clpru -v3 -o -DAM62X -DOUTPUTS16 -DPRU0_PREFETCH --endian=little --hardware_mac=on --obj_directory /tmp "/tmp/BBShiftPanel_prefetch_16.asm"
	clpru -v3 -DAM62X -DOUTPUTS16 -DPRU0_PREFETCH -z /opt/fpp/src/pru/AM62x_PRU0.cmd -o "non-gpl/BBShiftPanel/BBShiftPanel_prefetch_16.out" "/tmp/BBShiftPanel_prefetch_16.obj" -i/usr/share/ti/cgt-pru/lib -i/usr/share/ti/cgt-pru/include --library=libc.a
	@rm "/tmp/BBShiftPanel_prefetch_16.asm" "/tmp/BBShiftPanel_prefetch_16.obj"
...
non-gpl/BBShiftPanel/BBShiftPanel_oe_prefetch.out: non-gpl/BBShiftPanel/BBShiftPanel_oe.asm
	/usr/bin/cpp -P -I/opt/fpp/src/pru -DAM62X -DPRU0_PREFETCH "/opt/fpp/src/non-gpl/BBShiftPanel/BBShiftPanel_oe.asm" > "/tmp/BBShiftPanel_oe_prefetch.asm"
	clpru -v3 -o -DAM62X -DPRU0_PREFETCH --endian=little --hardware_mac=on --obj_directory /tmp "/tmp/BBShiftPanel_oe_prefetch.asm"
	clpru -v3 -DAM62X -DPRU0_PREFETCH -z /opt/fpp/src/pru/AM62x_PRU0.cmd -o "non-gpl/BBShiftPanel/BBShiftPanel_oe_prefetch.out" "/tmp/BBShiftPanel_oe_prefetch.obj" -i/usr/share/ti/cgt-pru/lib -i/usr/share/ti/cgt-pru/include --library=libc.a
	@rm "/tmp/BBShiftPanel_oe_prefetch.asm" "/tmp/BBShiftPanel_oe_prefetch.obj"
