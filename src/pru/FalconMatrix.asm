...
#ifdef SPLIT_GPIO
    ; park the copy PRU in case it started against scratchpad garbage
    SPLIT_FRAME_END
#endif
...
NO_EXIT:
    ...
    LDI statOffset, 0
#ifdef SPLIT_GPIO
    ; reset the pixel sequence before announcing the frame address so a
    ; stale publish from the previous frame can never match
    SPLIT_FRAME_START
#else
    XOUT 10, &data_addr, 4
#endif
